...
author: Shelley Valdovinos
description: Standard operating procedures for updating Jornada datasets in metabase (slightly out of date, probably)
date: 2022-12-08
---
...
> ![](img/image7.png){width="3.6875in"
> height="3.0416666666666665in"}

-   Find abstract: abstract.210370001.md.

> ![](img/image2.png){width="4.126619641294838in"
...
![](img/image10.png){width="6.005208880139983in"
...
-   \>**DataSet**: enter "DataSetID"= 210370001 into search engine and
    ...
    -   If no results: Add new row by clicking
        > ![](img/image3.png){width="0.15625in"
    ...
    -   Update the following fields, if applicable:
        ...
        -   **BoilerplateSetting:**
            > jrn-default![](img/image1.png){width="6.249405074365704in"
            > height="1.734375546806649in"}

        -   Save by clicking
            > "![](img/image11.png){width="0.15207020997375328in"
...
-   \>**DataSetAttributes**: enter "DataSetID"= 210370001 into search
    ...
    -   Save by clicking
        > "![](img/image11.png){width="0.15207020997375328in"
        > height="0.15228127734033245in"} Save" button at the
        > bottom.![](img/image9.png){width="5.671875546806649in"
...
-   \>**DataSetEntities** (to associate/attach files): enter
    ...
    -   For each data set, highlight row and click on
        > ![](img/image4.png){width="0.13541666666666666in"
...
![](img/image6.png){width="5.479166666666667in"
...
-   \>**DataSetPersonnel**: enter "DataSetID"= 210370001 into search
    ...
    -   ![](img/image8.png){width="5.182292213473316in"
