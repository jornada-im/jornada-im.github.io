...
This guide focuses mainly on data-related concerns, especially items 2 and 3, but some relevant forms and instructions are provided in the [Starting research](./starting-research.qmd) chapter of the guide. Safety and conduct guidance is found in the Jornada [Safety Handbook and Code of Conduct](https://drive.google.com/file/d/1aDyNo296N7Y1AO-BxLGcAhPj6yGK0u5S/view).
...
This guide is organized roughly according to the data lifecycle [@michener_ecoinformatics_2012], which outlines 8 distinct phases of working with data in a research context. In practice these phases overlap considerably in when the phase occurs and who executes them.

* **Planning** for research and data collection is covered in the [Starting research](starting-research.qmd) chapter.
...
Since there are a lot of projects to manage at the Jornada, and we have some unique project management practices, there is also a [Jornada project management](project-management.qmd) chapter.
