...
3. **Start creating structured metadata files and keep them with your data.**
    - Try to be systematic and complete about describing your data with metadata. A metadata template, such as one of [the Jornada templates](../../templates/index.qmd), helps with this.
