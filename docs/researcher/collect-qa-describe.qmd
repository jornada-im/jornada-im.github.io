...
![Say hello to the **dataset** -- a bundle of data and metadata. Data and metadata come in many forms and formats, and keeping them together forever will help preserve the meaning and utility of your research.](./img/a_dataset.png){width="40%" fig-align="center"}
:::
...
: Some examples of molecular sequencing/omics data and their attributes. Again, this is not an exhaustive list. 
...
[^2]: Reach out to the Jornada IM team at <jornada.data@nmsu.edu>, or to the EDI support channel at <support@edirepository.org>. Here is a [list of Information Managers](https://lternet.edu/using-lter-dat/#im) at all LTER sites.
[^3]: The [Data Curation Network](https://datacurationnetwork.org/) is a professional membership organization for data curators.
