...
The four attributes of data highlighted above are the beginning of **metadata**, or data that describe other data. Metadata provide important context about the data we work with and are essential for data to be useful (we devote more time to this later). Therefore, data and metadata should always travel together, and we have a special term for this pair: a **dataset**. Datasets are the fundamental units of data we work with and important research products, so we will refer to them often.

![Say hello to the **dataset** - a bundle of data and metadata. Data and metadata can come in many forms and formats, but we always want data to come with related metadata so we can understand and use them.](./img/a_dataset.png){width="40%" fig-align="center"}
:::
...
1. **Keep a detailed project log and populate it with useful metadata, such as:**
    ...
    b. for ancillary data (not directly collected by you), documentation of the original source of the data,
...
3. **Start creating structured metadata files and keep them with your data.**
    - Try to be systematic, organized, and complete about describing your data with metadata. Using a metadata template, such as one of [the Jornada templatess](../../templates/index.qmd), helps with this.
    - Organize your research data products in clearly-labeled project directories where data and metadata live together
...
1. You need data **AND METADATA** to make a publishable dataset.
