...
* Major geospatial data applications have metadata editing and exchange capabilities that are referenced to ISO standards. This includes implementations in [ESRI ArcGIS](https://www.esri.com/en-us/arcgis/geospatial-platform/overview) and the open-source [QGIS](https://qgis.org) ([metadata docs](https://docs.qgis.org/3.44/en/docs/user_manual/introduction/general_tools.html#metadata)) platform and its [plugins](https://plugins.qgis.org/search/?q=Metadata).
