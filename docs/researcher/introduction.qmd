...
This guide aims to cover all aspects of data work and is organized roughly according to the DataONE data lifecycle [@michener_ecoinformatics_2012], which outlines 8 distinct phases of working with data in a research context. In practice the phases overlap considerably the timing of activites and who executes them.
...
* We discuss data **collection**, **quality assurance**, and many aspects of **describing** data (with metadata) in the [Collect and manage data](collect-qa-describe.qmd) chapter.
* When you are ready to **preserve** your data by publishing it in a repository, read the [Prepare and publish](prepare-and-publish.qmd) chapter.
* To learn how and where to **discover** Jornada data, read the [Data discovery](discover-data.qmd) chapter.
