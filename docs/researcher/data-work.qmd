...
2. In the `data` subdirectory you will keep all data files you create and use for the project. We strongly recommend keeping a **data sources log**, which is a table where you list the source of all data files collected or downloaded for your research, here as well. Consider further dividing the `data` directory into subdirectories that are named and organized around your data processing and analysis activities. In the [Collecting data](collecting-data.qmd#cleaning-and-other-data-processing) chapter we discussed a couple ways to do this:  **raw, ready, and results** folders, or **numbered data levels**.
3. Keep all documentation in a `docs` subdirectory. Field notes, lab procedures, data analysis logs, and any other documentation that will be useful throughout the life of the project should be preserved here.
...
As we discussed in an earlier chapter about [cleaning and QA/QC](collecting-data.qmd#cleaning-and-other-data-processing), do your best to work with data using code or scripted workflows. 
