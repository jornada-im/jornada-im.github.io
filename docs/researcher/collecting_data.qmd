...
* Preserve the raw data in its original form
* Use reproducible, programmatic methods for cleaning and QA/QC, not manual editing.
* If you can, use numerical or statistical filters to find and remove outliers and error values, not "judgment calls" or "eyeballing it."
