...
:::{.callout-note}
## A new JRN website is under development!

The new JRN LTER website will be a static site based on the [Hugo](https://gethugo.io) site generator. The current development version is in [this GitHub repository](https://github.com/jornada-im/jrn-lter-website) and the site is rendered by Netlify at <https://jrn-lter-website.netlify.app/>.
...
These are described [below](chapter-02-website-and-comm.qmd#data-catalogs). 
