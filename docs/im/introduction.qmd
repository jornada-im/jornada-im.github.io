---
title: The Jornada Information Management Guide
...
Preface: [The JRN LTER Data Management Plan](../proposals-and-reports/JRN_data_management_plan.LTER8.qmd)
...
## The Jornada project and dataset numbering system
...
* [General Jornada metadata standards](standards/JRN_metadata_standards.qmd) for all data packages (this is a bit out of date)
* [Jornada keyword thesauri](../../archive/keyword_thesauri.xlsx) (.xlsx) list keywords that should appear in all Jornada metadata files (this is also out of date - refer to metabase).