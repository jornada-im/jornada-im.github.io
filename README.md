...
1. The easiest method is to file an issue in [this repository](https://github.com/jornada-im/jornada-im.github.io). Go to the [Issues tab](https://github.com/jornada-im/jornada-im.github.io/issues) at the top of the repository page and then select **New issue**. Provide a thorough description of your issue and suggested changes. You can even put suggested text into your issue. Once you submit it, the IM team will review and make changes.
